...
This repository contains a number of notebooks created using the Open Chemistry
projects to create notebooks that can be run locally and/or within Binder. The
binder directory shows what Python 3 modules are needed, and the JupyterLab
extension necessary to make everything work.
